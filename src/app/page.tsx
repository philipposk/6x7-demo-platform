  ...
  return (
    <div className="space-y-20">
      ...
      <section className="pt-8 text-center">
        ...
        {/* This very video was made by the tool, from this site's URL. */}
        <div className="mx-auto mt-10 max-w-3xl overflow-hidden rounded-2xl border border-zinc-800">
          <video src="/demo.mp4" controls autoPlay muted loop playsInline className="w-full" />
        </div>
        <p className="mt-2 text-xs text-zinc-600">↑ This demo was generated by the tool itself, from this page&apos;s URL.</p>
      </section>
